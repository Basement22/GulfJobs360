                    ...
                    <div style={{ textAlign: 'center' }} >
                        ...
                        <div style={{ textAlign: 'left' }}>
                            <div className={classes.box} style={{ background: 'transparent', boxShadow: 'none', marginBottom: '-40px', paddingTop: '10px' }} >
                                <Typography component="h1" className={classes.heading} style={{ marginLeft: '10px' }} variant="h1">
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                </Typography>
                                <Typography component="h1" className={classes.text} style={{ marginLeft: '10px' }} variant="h1">
                                    Quam ex delectus libero tempora ipsum dolores quis mollitia modi rerum,
                                </Typography>
                            </div>
                            ...
                            <div className={classes.box} style={{ paddingTop: '15px', paddingLeft: '2vw', paddingRight: '2vw', boxSizing: 'border-box' }} >
                                <Typography component="h1" className={classes.title} style={{ marginLeft: '10px' }} variant="h1">
                                    Your Company Details for registration with GulfJobs360
                                </Typography>
                                <Divider variant="middle" />
                                <div className={classes.paper}>
                                    <form className={classes.form} noValidate>
