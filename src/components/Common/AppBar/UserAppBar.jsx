        ...
        <div className={classes.root}>
            ...
            >
                <Toolbar>
                    ...
                    <div className={classes.listmenu}>
                        ...
                        >
                            ...
                            <ListItem
                                ...
                                className={classes.listItem}
                            >
                                <ListItemText primary="Services" className={classes.listItemText} />
                            </ListItem>
                            <ListItem
                                button
                                disableRipple={true}
                                ...
                                className={classes.listItem}
                            >
                                <ListItemText primary="Tips" className={classes.listItemText} />
                            </ListItem>
                        </List>
                    </div>
                    <Button
                    ...
                    >
                        <Avatar alt="Travis Howard" style={{ width: '35px', height: '35px', marginRight: '10px' }} src={assets.user} />
                        John Doe
            ...
            >
                <List>
                    {["Home", "Jobs", "Services", "Tips"].map((text, index) => (
