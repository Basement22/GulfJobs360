            ...
            <Grid container spacing={3}>
                <Grid item xs={12} >
                    <div className={classes.paper} style={{ marginTop: '20px', paddingBottom: '40px', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center', backgroundColor: '#13B493' }} >
                        <Typography component="h1" className={classes.heading} variant="h1" >Move Ahead in Career, Faster</Typography>
                        <Typography component="h1" className={classes.title} style={{ marginTop: '10px' }} variant="h1" >with our paid services</Typography>
                    </div>
                </Grid>
                <Grid item xs={4} >
